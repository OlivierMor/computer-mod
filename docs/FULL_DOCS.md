...
Every couple of ticks the Sensor scans the block it's attached to and **publishes the complete readings
table** onto its channel. Right-click the Sensor to set the **Channel** name; that's the only setting.
